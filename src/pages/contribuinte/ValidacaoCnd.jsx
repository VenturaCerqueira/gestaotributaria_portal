...
const EmissaoCnd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const result = await contribuinteApi.validacaoCnd({ cpf_cnpj: removeSeparador(documento), chave_validacao: chave });
    ...
    <div className="row">
      <div className="col-md-12">
        <div className="form-container">
          <h2 className="form-title">Validação de CND</h2>
              ...
              {loading
                ...
                <button
                  ...
                  disabled={
                    ...
                    Object.keys(cnd).length > 0 ||
                    error
                  }
                >
                  <FaFileAlt className="emissao-button-icon" />
                  <span>Validar CND</span>
                </button>
              }
