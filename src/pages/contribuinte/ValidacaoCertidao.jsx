...
const ValidacaoCertidao = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const result = await contribuinteApi.validacaoCertidao({ cpf_cnpj: removeSeparador(documento), chave_validacao: chave });

      setCertidao(result.certidao);
      setLoading(false);
    } catch (error) {
      setLoading(false);
    }
    ...
    <div className="row">
      <div className="col-md-12">
        <div className="form-container">
          <h2 className="form-title">Validação de certidão de baixa de atividade</h2>
