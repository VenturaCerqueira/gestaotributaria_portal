...
const DeclaracaoNaoInscrito = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const result = await contribuinteApi.declaracaoNaoInscrito({ cpf_cnpj: removeSeparador(documento) });
    ...
    <div className="row">
      <div className="col-md-12">
        <div className="form-container">
          <h2 className="form-title">Declaração de Não Inscrito</h2>
...
export default DeclaracaoNaoInscrito;
