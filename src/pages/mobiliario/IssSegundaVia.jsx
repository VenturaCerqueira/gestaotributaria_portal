...
import useMobiliarioService from "../../services/api/mobiliario";
...
const IssSegundaVia = () => {
	...
	const mobiliarioApi = useMobiliarioService();
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const result = await mobiliarioApi.segundaVia({
	...
	const handleImprimir = (cota) => {
		window.open(
			`${import.meta.env.VITE_API_URL}/portal-contribuinte/mobiliario/segunda-via/imprimir/${cota.numero}?entidade=${entidadeUrl}`,
			'_blank'
		);
	}
			...
			<div className="row">
				<div className="col-md-12">
					<div className="form-container">
						<h2 className="form-title">2ª via ISS</h2>
