...
import { cnpjValidate, cpfValidate, dateBr, removeSeparador, somenteNumero } from "../../utils/helper";
import useImobiliarioService from "../../services/api/imobiliario";
import { entidadeUrl } from "../../utils/global";

const ItivSegundaVia = () => {
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="form-container">
            <h2 className="form-title">2ª via ITIV</h2>
